...
class MVCUserViewController: UIViewController {
    var users: [User] = []
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let userDetailController = segue.destination as? MVCUserDetailViewController {
...
extension MVCUserViewController: UITableViewDataSource {
...
extension MVCUserViewController: UITableViewDelegate {
